...
public class view_trangChu extends javax.swing.JFrame {
     ...
     */
    public view_trangChu(view_dangNhap dn) {
        initComponents();
    ...
    public void maNV(String ma) {
        lblMaNV.setText(ma);
    }

    public void tenNV(String ten) {
        lblTenNV.setText(ten);
    }

    public String getMa() {
        maNV = lblTenNV.getText().trim();
        return maNV;
    }
    ...
    private void btn_hoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hoaDonActionPerformed
        bangHienThi.removeAll();
        viewHoaDon hd = new viewHoaDon(this);
        hd.setMaNV(lblMaNV.getText().trim());
    ...
    private void btn_banHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_banHangActionPerformed
        bangHienThi.removeAll();
        viewBanHang bh = new viewBanHang(this);
        bh.setMaNV(lblMaNV.getText().trim());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                view_trangChu view = new view_trangChu();
                view.setVisible(true);
